...
import { Anchor, Fish, Beer, Waves, Coffee, Utensils, Beef } from 'lucide-react';
...
const MenuCompleto: React.FC<MenuCompletoProps> = ({ seccionInicial = "mariscos" }) => {
  ...
  const menuSecciones: Record<string, MenuSeccion> = {
      ...
      categorias: [
        {
          ...
          items: [
            ...
            { nombre: "Taco de camarón", precio: "$25" },
        ...
        },
        {
          ...
          items: [
            { nombre: "Tostada de ceviche", precio: "$25" },
            { 
    ...
    infantil: {
      ...
      categorias: [
        {
          titulo: "Para los Pequeños",
          icon: <Beef className="h-5 w-5 text-amber-700" />,
          items: [
            { 
              nombre: "Hamburguesa", 
              precio: "$80",
              descripcion: "Con queso y papas fritas" 
            },
            { 
              nombre: "Baguette", 
              precio: "$70",
              subItems: [
                { nombre: "Jamón y queso", precio: "$70" },
                { nombre: "Pollo", precio: "$75" }
              ]
            },
            { nombre: "Orden de Papas Fritas", precio: "$45" }
          ]
        }
      ]
    },
